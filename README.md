# mzw-voice
“默筏”是一款专为表达障碍人群设计的中文智能输入系统，服务对象包括渐冻症、脑性麻痹、中风后遗症等无法正常说话或打字的用户。系统支持眼动或单指操作，通过九宫格布局降低误触率，结合中文拼音首字母输入习惯，利用大模型实现整句联想与补全。用户可以填写个性化偏好，让AI根据个人兴趣生成更贴切的表达内容。输入内容可语音朗读、自动保存，常用句支持一键调用。<br>
